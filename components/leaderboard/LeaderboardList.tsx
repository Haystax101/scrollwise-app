    ...
    const renderItem = ({ item, index }: { item: any; index: number }) => {
        ...
        return (
            <TouchableOpacity
                ...
                activeOpacity={0.7}
                style={{ borderRadius: 12, overflow: 'hidden' }} // Ensure rounded corners work with BlurView
            >
                <BlurView
                    intensity={40}
                    ...
                    style={[
                        ...
                        {
                            backgroundColor: isCurrentUser ? 'rgba(79, 70, 229, 0.15)' : 'transparent', // Highlight user, otherwise transparent glass
                            borderColor: isCurrentUser ? colors.primary : 'rgba(255, 255, 255, 0.1)',
                            borderWidth: 1,
                            // Removed top border/shadow logic, relying on glass + border
                        }
                    ]}
                >
